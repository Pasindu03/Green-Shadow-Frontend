$(document).ready(function () {
    ...
    function loadEquipment() {
        $.ajax({
            url: "http://localhost:8080/green-shadow/api/v1/equipments",
            method: "GET",
            headers: {
    ...
    $('#equipmentForm').submit(function (e) {
        ...
        const url = editIndex === -1
            ? "http://localhost:8080/green-shadow/api/v1/equipments"
            : `http://localhost:8080/green-shadow/api/v1/equipments/${editIndex}`;
    ...
    $(document).on('click', '.edit-equipment-btn', function () {
        ...
        $.ajax({
            url: `http://localhost:8080/green-shadow/api/v1/equipments/${id}`,
            method: "GET",
