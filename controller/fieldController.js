$(document).ready(function () {
    ...
    $('#fieldForm').on('submit', function (e) {
        ...
        const url = currentEditID
            ? `http://localhost:8080/green-shadow/api/v1/fields/${currentEditID}`
            : 'http://localhost:8080/green-shadow/api/v1/fields';
    ...
    $(document).on('click', '.edit-field', function () {
        ...
        $.ajax({
            url: `http://localhost:8080/green-shadow/api/v1/fields/${currentEditID}`,
            method: 'GET',
